...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_vocabularylearning, R.id.nav_vocabulayquiz,R.id.nav_grammarLearning, R.id.nav_slideshow, R.id.sign_out, R.id.nav_shopping, R.id.nav_profile,R.id.nav_shopping)
